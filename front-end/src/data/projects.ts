...
export const projects: Project[] = [
  {
    ...
    featured: true,
    status: "live",
    metrics: "Hybrid BM25 + Vector · Semantic Re-ranking · RAGAS Evaluated",
  ...
  },
  {
    ...
    featured: true,
    status: "live",
    metrics: "60% reduction in manual reporting · 3-agent pipeline · MCP tool layer",
